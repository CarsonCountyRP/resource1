...
// Text settings
const name = "<strong>Carson</strong>County"
const underName = "ROLE<b>PLAY</b>"
const desc = "CarsonCounty is a server featuring an extensive collection of custom scripts, maps, vehicles, unique weapons, and much more."


// Social media
const discord = "https://discord.gg/ukgTAD2XgJ"  // If = "" then icon will not show up on screen
